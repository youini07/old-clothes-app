...
exports.globalErrorHandler = exports.asyncHandler = void 0;
/**
 * 왜 필요한가:
...
const globalErrorHandler = (err, req, res, _next) => {
    ...
    res.status(500).json(Object.assign({ error: '서버 내부 오류가 발생했습니다. 잠시 후 다시 시도해주세요.', code: 'INTERNAL_ERROR' }, (isDev && { detail: err.message })));
};
