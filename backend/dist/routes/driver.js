...
// 기사 본인 하루 정산 통계 조회
// ============================================
router.get('/daily-stats', authMiddleware_1.authenticate, (0, authMiddleware_1.requireRole)(['DRIVER', 'PARTNER']), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.user.userId;
...
// 커스텀 문자 템플릿 저장 및 조회
// ============================================
router.get('/sms-template', authMiddleware_1.authenticate, (0, authMiddleware_1.requireRole)(['DRIVER', 'PARTNER']), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.user.userId;
        const driver = yield prisma_1.prisma.driverProfile.findUnique({
            where: { userId }
...
router.put('/sms-template', authMiddleware_1.authenticate, (0, authMiddleware_1.requireRole)(['DRIVER', 'PARTNER']), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.user.userId;
